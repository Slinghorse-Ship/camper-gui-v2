...
Item {
    ...
    Rectangle {
        ...
        Text {
            x: 98
            y: 31
            text: view.chargers.length + " Victron MPPT · INDEVOLT SOLAR " + (view.indevolt.online ? "online" : "offline") + " · ORION " + (view.orion.on ? "ein" : "aus") + (view.indevolt.gridConnection && view.indevolt.gridConnection.available ? " · CAMPERNETZ " + (view.indevolt.gridConnection.on ? "frei" : "getrennt") : "")
        ...
        Text {
            ...
            text: view.fmt(view.solar.power, 0, " W")
            color: view.solarColor
            font.pixelSize: 20
            font.bold: true
        }
        Text {
        ...
        Text {
            ...
            width: 112
            horizontalAlignment: Text.AlignRight
            text: view.fmt(Number(view.solar.power || 0) + Number(view.indevolt.solarPower || 0), 0, " W")
            color: view.textColor
            font.pixelSize: 20
            font.bold: true
        }
    ...
    Rectangle {
        ...
        Text {
            x: 14
            y: 12
            text: "VICTRON SMARTSOLAR MPPT"
            color: view.mutedColor
            font.pixelSize: 9
            font.bold: true
        }
        Text {
            visible: view.chargers.length === 0
            anchors.centerIn: parent
            text: "Keine MPPT-Daten verfügbar"
            color: view.mutedColor
            font.pixelSize: 13
        }
        Flickable {
            ...
            clip: true
            contentWidth: width
            contentHeight: mpptColumn.height
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        Rectangle {
                            ...
                            height: 62
                            radius: 2
                            color: charger.online ? view.solarColor : view.mutedColor
                        }
                        Text {
                            x: 14
                            y: 9
                            ...
                            text: charger.name || "SmartSolar MPPT"
                            color: view.textColor
                            font.pixelSize: 13
                            font.bold: true
                        }
                        Text {
                            ...
                            width: 245
                            elide: Text.ElideRight
                            text: "Instanz " + charger.instance + (charger.serial ? " · " + charger.serial : "")
                            color: view.mutedColor
                            font.pixelSize: 8
                        }
                        Text {
                            ...
                            width: 245
                            elide: Text.ElideRight
                            text: view.stateName(charger.state)
                            color: charger.online ? view.greenColor : view.mutedColor
                            font.pixelSize: 10
                            font.bold: true
                        }
                        Text {
                            ...
                            width: 82
                            horizontalAlignment: Text.AlignRight
                            text: view.fmt(charger.power, 0, " W")
                            color: view.solarColor
                            font.pixelSize: 20
                            font.bold: true
                        }
                        ...
                        Text {
                            ...
                            width: 84
                            horizontalAlignment: Text.AlignRight
                            text: view.fmt(charger.pvVoltage, 1, " V")
                            color: view.textColor
                            font.pixelSize: 15
                            font.bold: true
                        }
                        ...
                        Text {
                            ...
                            width: 176
                            horizontalAlignment: Text.AlignRight
                            text: "Heute " + view.fmt(charger.yieldTodayKwh, 2, " kWh")
                            color: view.mutedColor
                            font.pixelSize: 9
                        }
                    }
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            height: 112
            radius: 11
            color: view.orion.on ? (view.dayMode ? "#e2f5ef" : "#143027") : view.panelColor
            border.color: view.orion.online ? view.greenColor : view.lineColor
        }
        Text {
            x: 27
            y: 41
            text: view.orion.online ? view.orion.stateText || "BEREIT" : "NICHT ERREICHBAR"
            color: view.orion.online ? view.greenColor : view.mutedColor
            font.pixelSize: 9
            font.bold: true
        }
        Text {
            ...
            y: 62
            width: 160
            text: view.fmt(view.orion.power, 0, " W")
            color: view.textColor
            font.pixelSize: 21
            font.bold: true
        }
        Text {
            ...
            y: 91
            width: 164
            text: "LIMA  " + view.fmt(view.orion.inputVoltage, 1, " V") + " · " + view.fmt(view.orion.inputPower, 0, " W")
            color: view.mutedColor
            font.pixelSize: 8
            font.bold: true
        }
        Text {
            ...
            y: 111
            width: 164
            text: "→ BORD  " + view.fmt(view.orion.voltage, 1, " V") + " · " + view.fmt(view.orion.current, 1, " A")
            color: view.mutedColor
            font.pixelSize: 8
            font.bold: true
        }
        ...
        Rectangle {
            ...
            height: 154
            radius: 11
            color: view.indevolt.online ? (view.dayMode ? "#fff8d9" : "#2d2914") : view.panelColor
            border.color: view.indevolt.online ? view.solarColor : view.lineColor
        }
        Text {
            x: 27
            y: 185
            text: view.indevolt.online ? "ONLINE" : "NICHT ERREICHBAR"
            color: view.indevolt.online ? view.greenColor : view.mutedColor
            font.pixelSize: 9
            font.bold: true
        }
        CamperTouchButton {
        ...
        Text {
            ...
            y: 208
            width: 142
            text: view.fmt(view.indevolt.solarPower, 0, " W")
            color: view.solarColor
            font.pixelSize: 25
            font.bold: true
        }
        ...
        Text {
            ...
            y: 263
            width: 105
            text: view.fmt(view.indevolt.soc, 0, " %")
            color: view.textColor
            font.pixelSize: 16
            font.bold: true
        }
        ...
        Text {
            ...
            width: 107
            horizontalAlignment: Text.AlignRight
            text: view.fmt(view.indevolt.batteryPower, 0, " W")
            color: view.textColor
            font.pixelSize: 16
            font.bold: true
        }
