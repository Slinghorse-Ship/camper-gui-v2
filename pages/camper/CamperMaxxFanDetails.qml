...
Item {
    ...
    Rectangle {
        ...
        CamperLineIcon {
            ...
            height: 35
            kind: "fan"
            lineColor: view.fan.on ? view.blueColor : view.mutedColor
            strokeWidth: 2
        }
        Text {
            x: 143
    ...
    Rectangle {
        ...
        Text {
            ...
            color: view.fan.on ? view.blueColor : view.textColor
            font.pixelSize: 36
            font.bold: true
        }
        Text {
            x: 14
            y: 87
            text: view.fan.on ? "LÜFTER AKTIV" : "LÜFTER AUS"
            color: view.fan.on ? view.greenColor : view.mutedColor
            font.pixelSize: 10
            font.bold: true
        }
        Rectangle {
        ...
        Text {
            ...
            text: view.fan.mode === "reverse" ? "RÜCKWÄRTS" : "VORWÄRTS"
            color: view.textColor
            font.pixelSize: 11
            font.bold: true
        }
        ...
        Text {
            ...
            width: 106
            horizontalAlignment: Text.AlignRight
            text: view.fan.autoHold ? "AKTIV" : "AUS"
            color: view.fan.autoHold ? view.greenColor : view.textColor
            font.pixelSize: 11
            font.bold: true
        }
        Text {
